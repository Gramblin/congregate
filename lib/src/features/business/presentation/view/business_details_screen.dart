          ...
          ? Column(
              ...
              children: [
                FloatingActionButton.extended(
                  heroTag: 'post_event',
                  onPressed: () => _showSheet(context, ref, type: 'event'),
                ...
                FloatingActionButton.extended(
                  ...
                  onPressed: () => _showSheet(context, ref, type: 'product'),
          ...
          if (current.contactPublic || isOwner) ...[
            ...
            if (current.email != null)
              ListTile(
                ...
                onTap: () => launchUrl(Uri.parse('mailto:${current.email}')),
              ),
            if (current.phone != null)
              ListTile(
                ...
                onTap: () => launchUrl(Uri.parse('tel:${current.phone}')),
              ),
